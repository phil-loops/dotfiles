...
export function SessionPicker(props: { onPick: (session?: string) => void; onClose: () => void }) {
  ...
  return (
    <div
      class="session-pop absolute top-[calc(100%+6px)] right-0 z-[62] flex w-[260px] cursor-default flex-col gap-px rounded-lg border border-[#3a332b] bg-[#1b1815] p-[5px] text-left text-[11.5px] normal-case not-italic shadow-[0_12px_32px_rgba(0,0,0,.5)] [letter-spacing:normal]"
      ref={el}
    >
